...
function About() {
  return (
    <div className="bg-gray-50 overflow-x-hidden mb-10 min-h-full flex flex-col items-center justify-center">
      <div className="max-w-7xl mx-0 ml-5 p-6 bg-white rounded-lg shadow-md">
