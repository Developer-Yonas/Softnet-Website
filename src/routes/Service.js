...
const Service = () => {
  ...
  return (
    <div id="top" className="max-w-7xl mx-auto p-6 border rounded shadow-md">
    
      <h2 className="text-4xl text-violet-900 font-semibold mb-10"> Services</h2>
      <div className="flex flex-wrap -mx-5 cursor-pointer">
        <div className="w-full md:w-1/2 lg:w-1/2 px-4 mb-4">
        <Link to="/services/TechnologyTraining" onClick={scrollToTop}>
        ...
        <div className="w-screen md:w-1/2 lg:w-1/2 px-4 mb-4">
          <Link to="/services/Infrastructure" onClick={scrollToTop}>
        ...
        <div className="w-full md:w-1/2 lg:w-1/2 px-4 mb-4">
          <Link to="/services/Softwaredevelopment" onClick={scrollToTop}>
        ...
        <div className="w-full md:w-1/2 lg:w-1/2 px-4 mb-4">
          <Link to="/services/ITO" onClick={scrollToTop}>
            <div className="bg-white p-6 rounded border hover:bg-gray-300 transition duration-300">
              <div className="flex items-center justify-between">
                <h3 className="text-2xl text-violet-800 font-semibold mb-2 flex items-center">
