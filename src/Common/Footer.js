    ...
    <li>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          ...
          <div class="flex mt-0 sm:justify-center sm:mt-0">
              <a href="#" class="text-blue-500 hover:text-red-900 dark:hover:text-white">
              ...
              <a href="#" class="text-red-500 hover:text-blue-900 dark:hover:text-white ms-5">
              ...
              <a href="#" class="text-grey-500 hover:text-blue-900 dark:hover:text-white ms-5">
                  <svg class="w-7 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
